...
short_description: Gathers information about PowerMax/VMAX Storage
                   entities
...
class PowerMaxGatherFacts(object):
    ...
    def __init__(self):
        ...
        if serial_no is '':
            ...
            LOG.info(
                    'Got PyU4V Unisphere instance for common lib '
    ...
    def get_volume_list(self):
        ...
        try:
            ...
            LOG.info('Successfully listed {0} volumes from array {1}'
                    .format(len(vol_list), array_serial_no))
            return vol_list

        except Exception as e:
            msg = 'Get Volumes for array {0} failed with error {1} '\
    ...
    def get_storage_group_list(self):
        ...
        try:
            ...
            LOG.info('Successfully listed {0} Storage Group from '
                     'array {1}'.format(len(sg_list), array_serial_no))
            return sg_list

        except Exception as e:
            msg = ('Get Storage Group for array {0} failed with error '
    ...
    def get_array_list(self):
        ...
        try:
            ...
            LOG.info('Got {0} Arrays from Unisphere Host  {1}'
                    .format(len(array_list),
                            self.module_params['unispherehost']))
            return array_list

        except Exception as e:
            msg = ('Get Array List for Unisphere host {0} failed with'
                   'error {1}'.format(self.module_params
                                      ['unispherehost'],
                                      str(e)))
            LOG.error(msg)
            self.module.fail_json(msg=msg)
    ...
    def get_srp_list(self):
        ...
        try:
            ...
            LOG.info('Got {0} Storage Resource Pool from array {1}'
                    .format(len(srp_list), array_serial_no))
            return srp_list

        except Exception as e:
            msg = ('Get Storage Resource Pool for array {0} failed'
                   'with error {1} '
                   .format(self.module.params['serial_no'], str(e)))
            LOG.error(msg)
            self.module.fail_json(msg=msg)
    ...
    def get_masking_view_list(self):
        ...
        try:
            ...
            LOG.info('Got {0} Getting Masking View from array {1}'
                    .format(len(mv_list), array_serial_no))
            return mv_list
