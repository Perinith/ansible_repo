...
class PowerMaxSnapshot(object):
    ...
    def get_snapshot(self, sg_id, snapshot_name, generation):
        ...
        try:
            ...
            LOG.error(error_message.format(str(e), sg_id,
                                           snapshot_name))
    ...
    def create_sg_snapshot(self, sg_id, snap_name, ttl, ttl_unit):
        ...
        try:
            ...
            self.module.fail_json(msg=error_message.format(snap_name,
                                                           sg_id,
                                                           str(e)))
    ...
    def rename_sg_snapshot(self, sg_id, snap_name, new_snap_name,
        ...
        try:
            ...
            error_message = 'Renaming Snapshot {0} for Storage Group ' \
    ...
    def change_snapshot_link_status(self, sg_id, target_sg,
        ...
        if generation is None:
            error_message = 'Change SG {0} Snapshot {1} link status ' \
                            'failed. Please provide a valid generation '
    ...
    def perform_module_operation(self):
        ...
        if state == 'present' and ttl and not \
            ...
            LOG.info('Delete storage group {0} snapshot {1} generation '
                     '{2} '.format(sg_name, snapshot_name, generation))
            result['delete_sg_snap'] = self\
                                    .delete_sg_snapshot(sg_name,
                                                       snapshot_name,
                                                       generation)
